...
if __name__ == "__main__":
    ...
    psi = dxchange.read_tiff(data_prefix+'/matlab-recon.tif')[:,::step,::step].astype('complex64')
    ...
    with ptychotomo.SolverLam(n,n,n,det,ntheta,lamino_angle,eps=1e-2) as tslv:
        ...
        dxchange.write_tiff_stack(u.real,data_prefix+'rec_lam_matlab'+str(n)+str(nscan)+'/r'+str(center)+'.tiff',overwrite=True)
